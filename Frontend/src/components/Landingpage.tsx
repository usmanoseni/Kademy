      ...
      <div className={`flex-col justify-center items-center w-full  h-full ${theme === 'dark' ? 'bg-slate-900' : 'bg-radial-[at_ 25%_50%_75%] from-white via-blue-100/10 to-indigo-300/20 to-90%'}`}>
        <div className={`${theme === 'dark' ? 'pattern' : 'pattern'} w-full h-[100vh] max-sm:h-[75vh]  flex-col justify-center items-center gap-10 flex relative`}>
          ...
          <div className='flex justify-center items-center gap-4 '>
            <a href="#"><button className='border border-gray-900 px-6 max-sm:text-sm py-2 rounded-md cursor-pointer font-medium hover:bg-gradient-to-br hover:from-blue-500 hover:to-indigo-700 hover:text-white relative z-20 dark:border-white hover:border-indigo-600 '>
              Register
            </button></a> 
            <a href="#"><button className="flex max-sm:text-sm bg-gradient-to-br from-blue-500 to-indigo-700 cursor-pointer transition-all duration-200 text-white py-2 px-3 justify-center items-center relative z-20 gap-2.5 rounded-lg hover:from-blue-600 hover:to-indigo-700">
              Start Learning
              ...
              <div className="relative z-10 px-7 grid grid-cols-1 md:grid-cols-2 gap-6 py-5">
                <div className='relative flex-col gap-6 justify-center content-center w-full h-full '> 
                    <h2 className='max-sm:text-2xl/8  max-md:text-3xl text-4xl  font-bold text-blue-950 mb-2  font-google-sans-flex max-md:text-center'>Start learning at <br /> your pace now</h2>
                      ...
                      <a href="#"><button className="flex max-md:hidden max-sm:text-sm mt-6 bg-gradient-to-br  from-orange-400 to-rose-600 cursor-pointer transition-all duration-200 text-white py-2 px-3 justify-center items-center relative z-20 gap-2.5 rounded-lg hover:from-orange-600 hover:to-rose-700">
                            Rigister with Us 
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className=" text-white max-sm:size-5.5 size-7 rotate-45 ">
                              <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm.53 5.47a.75.75 0 0 0-1.06 0l-3 3a.75.75 0 1 0 1.06 1.06l1.72-1.72v5.69a.75.75 0 0 0 1.5 0v-5.69l1.72 1.72a.75.75 0 1 0 1.06-1.06l-3-3Z" clip-rule="evenodd" />
                            </svg>
                  ...
                  <div  className='flex gap-3 justify-center lg:justify-evenly max-md:py-1 py-6 w-full h-full'>
                    <div className='flex-col text-white border-l-3 border-white px-5 py-4 content-center '>
                      <div className='text-3xl sm:text-4xl lg:text-5xl font-goldman font-extrabold '>2000+</div>
                      <div className='text-lg font-semibold text-orange-200 '>Students</div>
                    </div>
                    <div className='flex-col text-white border-l-3 border-white px-5 py-4 content-center '>
                      <div className='text-3xl sm:text-4xl lg:text-5xl font-goldman font-extrabold '>158+</div>
                      <div className='text-lg font-semibold text-orange-200 '>Tutors</div>
                    </div>
                  </div>
                  <div className='flex justify-center items-center'>
                    <a href="#"><button className="flex md:hidden max-sm:text-sm  bg-gradient-to-br  from-orange-400 to-rose-600 cursor-pointer transition-all duration-200 text-white py-2 px-3 justify-center items-center relative z-20 gap-2.5 rounded-lg hover:from-orange-600 hover:to-rose-700">
                            Rigister with Us 
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className=" text-white max-sm:size-5.5 size-7 rotate-45 ">
                              <path fill-rule="evenodd" d="M12 2.25c-5.385 0-9.75 4.365-9.75 9.75s4.365 9.75 9.75 9.75 9.75-4.365 9.75-9.75S17.385 2.25 12 2.25Zm.53 5.47a.75.75 0 0 0-1.06 0l-3 3a.75.75 0 1 0 1.06 1.06l1.72-1.72v5.69a.75.75 0 0 0 1.5 0v-5.69l1.72 1.72a.75.75 0 1 0 1.06-1.06l-3-3Z" clip-rule="evenodd" />
                            </svg>
